...
// PE and Multipliers
parameter integer X = 4;  // fixed to 4 for MX, NV system energy breakdown
parameter integer Y = 4;  // fixed to 4 for MX, NV system energy breakdown
parameter integer B = 32; // block size 32 for MX
